                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('email-templates.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="body" id="body" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required></textarea>
                        </div>
